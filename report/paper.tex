...
\easyfigdefault{placement={!htb}, max width=20pc, max height=.5\textheight, keepaspectratio}
...
Finally, if someone finds a song they like, there is a good chance that the song's producer has made other likable songs. Our search engine would be one more avenue for users to find new material to enjoy themselves with.
...
\Figure[caption=Search Failure With cmd.exe]{res/cmd_search_fail.png}
...
\Figure[caption=Search Success With PuTTY]{res/putty_search_success.png}
